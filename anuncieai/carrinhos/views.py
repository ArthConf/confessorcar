...
from carrinhos.models import CarItem
from carrinhos.models import Carrinho
from produtos.models import Produto

#--obtendo a sessão se existir, senão criaremos uma nova sessão
...
def visualizarCarrinho(request, total=0, quantidade=0, car_items=None):
        try:
                ...
                pass
        contexto = {'car_items':car_items}

        return render(request, 'loja/carrinho/carrinho.html')
